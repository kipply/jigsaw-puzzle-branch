...
class TimerWidget (Gtk.HBox):
    ...
    def __init__ (self, bg_color="#DD4040", fg_color="#4444FF", lbl_color="#DD4040", can_stop=True):
        ...
        self.counter.modify_bg(Gtk.StateFlags.NORMAL, Gdk.color_parse(bg_color))
        self.counter.set_size_request(120, -1)
        hb = Gtk.HBox()
        self.counter.add(hb)
        self.lbl_time = Gtk.Label()
        self.lbl_time.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse(lbl_color))
        self.pack_start(self.lbl_time, False, True, 0)
        self.time_label = Gtk.Label("--:--")
        self.time_label.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse(fg_color))
